...
namespace Better_Pumpkin_Fusion
{
	...
	public class Plugin : BasePlugin
	{
		...
		{
			Log.LogInfo("Better Pumpkin Fusion is loaded!");
	...
	{
		private static readonly Dictionary<PlantType, PlantType> plantMixDictionary = new Dictionary<PlantType, PlantType>
		{
